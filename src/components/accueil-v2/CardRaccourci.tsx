...
export default function CardRaccourci({ className, label = "Accédez aux lois mises en vigueur." }: CardRaccourciProps) {
  return (
    <div className={className}>
      <div className="bg-white border-2 border-transparent hover:border-[#ecf5f8] transition-colors flex-1 relative rounded-[24px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.06)] w-full h-full min-h-[272px]">
