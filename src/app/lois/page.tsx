        ...
        {!isLoading && !error && lois && lois.length > 0 && (
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
              {currentLois.map((loi) => (
                <div key={loi.id} className="bg-white rounded-3xl border border-[#E7EAED] p-6 h-[172px] w-full flex flex-col justify-between">
                  <div className="flex flex-col gap-[20px]">
                    <h2 className="font-['Montserrat'] text-normal text-[14px]">{loi.titre}</h2>
