  ...
  return (
    <div className="bg-[#f5fcfe] min-h-screen relative">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-12 items-start px-12 w-full mx-auto mb-12">
          {/* Tabs */}
          <div className="flex flex-col gap-6 w-full">
            <div className="flex gap-12 items-center w-full">
              <button
                onClick={() => setActiveTab('securite')}
                className={`text-[20px] leading-normal ${activeTab === 'securite' ? 'text-[#053f5c]' : 'text-[#94a3b8]'
                  }`}
              ...
              <button
                ...
                className={`text-[20px] leading-normal ${activeTab === 'notifications' ? 'text-[#053f5c]' : 'text-[#94a3b8]'
                  }`}
                style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 500 }}
              >
                Notifications
              ...
              <button
                ...
                className={`text-[20px] leading-normal whitespace-nowrap ${activeTab === 'langue' ? 'text-[#053f5c]' : 'text-[#94a3b8]'
                  }`}
                style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 500 }}
              >
                Langue & Région
              ...
              <button
                ...
                className={`text-[20px] leading-normal whitespace-nowrap ${activeTab === 'confidentialite' ? 'text-[#053f5c]' : 'text-[#94a3b8]'
                  }`}
                style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 500 }}
              >
            ...
            <div className="flex flex-col gap-12 w-full">
              ...
              <div className="flex flex-col gap-6 w-full">
                ...
                <button
                  ...
                  disabled={loading}
                  className={`px-4 py-2 rounded-md self-start text-[#242a35] text-[14px] leading-normal transition-colors ${loading
                    ? 'bg-gray-400 cursor-not-allowed'
                    : 'bg-[#f27f09] hover:bg-[#e06f08]'
                    }`}
                  style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 500 }}
                >
              ...
              <div className="bg-white rounded-[24px] px-3.5 py-8 w-full">
                <div className="flex items-center justify-between w-full">
                  ...
                  <button
                    ...
                    className={`w-[60px] h-[30px] rounded-[24px] p-[5px] transition-colors ${twoFactorEnabled ? 'bg-[#f27f09]' : 'bg-[#e2e8f0]'
                      }`}
                  >
                    <div
                      className={`w-5 h-5 bg-white rounded-full transition-transform ${twoFactorEnabled ? 'translate-x-[30px]' : 'translate-x-0'
                        }`}
                    />
                  </button>
                </div>
